...
class FlushWithEdgesTests: XCTestCase {
    ...
    func testFlushWithLeadingEdgeOf() {
        ...
        let constraints = viewOne.flush(withLeadingEdgeOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
    ...
    func testFlushWithTrailingEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.flush(withTrailingEdgeOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
    ...
    func testFlushWithTopEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.flush(withTopEdgeOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
    ...
    func testFlushWithBottomEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.flush(withBottomEdgeOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
    ...
    func testFlushWithVerticalEdgesOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.flush(withVerticalEdgesOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
    ...
    func testFlushWithHorizontalEdgesOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.flush(withHorizontalEdgesOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
    ...
    func testFlushWithEdgesOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.flush(withEdgesOf: viewTwo, insetBy: 10.0, multiplier: 2.0, priority: Constraid.LayoutPriority(rawValue: 500))
