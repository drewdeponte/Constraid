...
class ExpandFromMarginTests: XCTestCase {
    func testExpandFromLeadingMarginOf() {
        ...
        let constraints = viewOne.expand(fromLeadingMarginOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
    ...
    func testExpandByTrailingMarginOf() {
        ...
        let constraints = viewOne.expand(fromTrailingMarginOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
        let constraintOne = viewOne.constraints.first! as NSLayoutConstraint
    ...
    func testExpandFromTopMarginOf() {
        ...
        let constraints = viewOne.expand(fromTopMarginOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
        let constraintOne = viewOne.constraints.first! as NSLayoutConstraint
    ...
    func testExpandFromBottomMarginOf() {
        ...
        let constraints = viewOne.expand(fromBottomMarginOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
        let constraintOne = viewOne.constraints.first! as NSLayoutConstraint
    ...
    func testExpandFromHorizontalMarginsOf() {
        ...
        let constraints = viewOne.expand(fromHorizontalMarginsOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
        let constraintOne = viewOne.constraints.first! as NSLayoutConstraint
    ...
    func testExpandFromVerticalMarginsOf() {
        ...
        let constraints = viewOne.expand(fromVerticalMarginsOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
        let constraintOne = viewOne.constraints.first! as NSLayoutConstraint
        let constraintTwo = viewOne.constraints.last! as NSLayoutConstraint
    ...
    func testExpandFromMarginsOf() {
        ...
        let constraints = viewOne.expand(fromMarginsOf: viewTwo, constant: 10.0, multiplier: 2.0, priority: 500)
