...
class ManageRelativePositionTests: XCTestCase {
    func testFollowsTheTrailingMarginOf() {
        ...
        let constraints = viewOne.follows(theTrailingMarginOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testPrecedesTheLeadingMarginOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.precedes(theLeadingMarginOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testSitsAboveTheTopMarginOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.sits(aboveTheTopMarginOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testSitsBelowTheBottomMarginOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.sits(belowTheBottomMarginOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testFollowsTheTrailingEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.follows(theTrailingEdgeOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testPrecedesTheLeadingEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.precedes(theLeadingEdgeOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testSitsAboveTheTopEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.sits(aboveTheTopEdgeOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
    ...
    func testSitsBelowTheBottomEdgeOf() {
        ...
        viewOne.addSubview(viewTwo)
        let constraints = viewOne.sits(belowTheBottomEdgeOf: viewTwo, by: 10.0, multiplier: 2.0, priority: ConstraidLayoutPriority(rawValue: 500))
