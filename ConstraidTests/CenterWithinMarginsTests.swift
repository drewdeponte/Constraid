...
class CenterWithinMarginsTests: XCTestCase {
    func testCenterVerticallyWithinMarginsOffsetDown() {
        ...
        XCTAssertEqual(constraintOne.secondAttribute, NSLayoutConstraint.Attribute.centerYWithinMargins)
    ...
    func testCenterHorizontallyWithinMarginsOffsetRight() {
        ...
        XCTAssertEqual(constraintOne.relation, NSLayoutConstraint.Relation.equal)
        XCTAssertEqual(constraintOne.secondItem as! UIView, viewTwo)
        XCTAssertEqual(constraintOne.secondAttribute, NSLayoutConstraint.Attribute.centerXWithinMargins)
        XCTAssertEqual(constraintOne.constant, 10.0)
        XCTAssertEqual(constraintOne.multiplier, 2.0)
        XCTAssertEqual(constraintOne.priority, UILayoutPriority(rawValue: UILayoutPriority.RawValue(500)))
    ...
    func testCenterWithinMarginsOffsetDownAndRight() {
        ...
        XCTAssertEqual(constraintTwo.secondAttribute, NSLayoutConstraint.Attribute.centerYWithinMargins)
